...
const Stocks = () => {
    const [lockerDetails, setlockerDetails] = useState(stocks);
    ...
    return (
        <>
            <div className="mt-7 myscroll">
                ...
                <div>
                    <h3 className="mb-4 text-lg font-medium leading-none text-gray-900 dark:text-white  ml-96" >Stocks Details</h3>
                    ...
                    <div className="grid gap-4 mb-4 sm:grid-cols-2 ml-2">
                        <div>
                            ...
                            <input type="text" onChange={handleInputChange} name="product" id="product" className="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Product" required="" />
                        </div>
                        <div>
                            <label htmlFor="UnitPrice" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit Price</label>
                            <input type="text" onChange={handleInputChange} name="UnitPrice" id="UnitPrice" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Unit price" required="" />
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4 mb-4 sm:grid-cols-2 ml-2">
                        <div>
                            <label htmlFor="Qtyinhand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qty in hand</label>
                            <input type="text" onChange={handleInputChange} name="Qtyinhand" id="Qtyinhand" className="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Quantity in hand" required="" />
                        </div>
                        <div>
                            <label htmlFor="QtySold" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qty Sold</label>
                            <input type="text" onChange={handleInputChange} name="QtySold" id="QtySold" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Quantitysold" required="" />
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4 mb-4 sm:grid-cols-2 ml-2">
                        <div>
                            <label htmlFor="inventoryValue" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">inventory Value</label>
                            <input typetype="text" onChange={handleInputChange} name="inventoryValue" id="inventoryValue" className="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="inventory value" required="" />
                        </div>
                        <div>
                        <label htmlFor="salesValue" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sales Value</label>
                        <input type="text" onChange={handleInputChange} name="salesValue" id="salesValue" class="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Sales value" required="" />
                     </div>
                    </div>
                    ...
                    <div className="grid gap-4 mb-4 sm:grid-cols-2 ml-2">
                        <div>
                            <label htmlFor="AvailableStocks" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Available Stocks</label>
                            <input typetype="text" onChange={handleInputChange} name="AvailableStocks" id="AvailableStocks" className="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Available stocks" required="" />
                        </div>
                        <div>
                        <label htmlFor="status" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status</label>
                        <input type="text" onChange={handleInputChange} name="status" id="status" class="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Current status" required="" />
                     </div><br/>
                    </div>
